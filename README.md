...
Using AbstractUser() to extend GraphQL User in order to add fields to the User model without stepping on its toes. It is important to not accidentally duplicate fields already on the GraphQL User model as that shifts the responsibility of password hashing and validation over to you. This model represents the user of the application.

Fields being used from GraphQL User model:
...
#### On User Model: WE WILL CHANGE TO COMPANY, USER, INVOICE, ITEMS
...
#### User Mutations: WE WILL CHANGE TO COMPANY, USER, INVOICE, ITEMS

##### Create User

```
- Enter WE WILL CHANGE TO COMPANY, USER, INVOICE, ITEMS
```

##### Edit User

```
- WE WILL CHANGE TO COMPANY, USER, INVOICE, ITEMS
```
